...
class View:
    def __init__(self, top=None):
        ...
        self._img1 = tk.PhotoImage(file="Mouzikka-music-app/icons/pause.png")
        ...
        self._img2 = tk.PhotoImage(file="Mouzikka-music-app/icons/play.png")
        ...
        self._img3 = tk.PhotoImage(file="Mouzikka-music-app/icons/stop.png")
        ...
        self._img4 = tk.PhotoImage(file="Mouzikka-music-app/icons/vinylrecord.png")
        ...
        self._img5 = tk.PhotoImage(file="Mouzikka-music-app/icons/previous.png")
        ...
        self._img6 = tk.PhotoImage(file="Mouzikka-music-app/icons/add.png")
        ...
        self._img7 = tk.PhotoImage(file="Mouzikka-music-app/icons/delete.png")
        ...
        self._img8 = tk.PhotoImage(file="Mouzikka-music-app/icons/like.png")
        ...
        self._img9 = tk.PhotoImage(file="Mouzikka-music-app/icons/broken-heart.png")
        ...
        self._img10 = tk.PhotoImage(file="Mouzikka-music-app/icons/refresh.png")
    ...
    def setup_player(self):
        ...
        self.deleteSongsFromPlaylistButton.config
        ...
        self.playList.bind("<Double-1>",self.load_double_click)
        self.top.title("MOUZIKKA - Dance to t-music-appm of your heart")
        img = tk.PhotoImage(file="Mouzikka-music-app/icons/icon_music1.png")
    ...
    def show_timer(self,total_sec):
        ...
        while current_second<=total_sec and mixer.music.get_busy():
            if self.isPause:
                continue
            min,sec = divmod(current_second,60)  
            min = round(min)
            sec = round(sec)
    ...
    def remove_song_from_favourites(self):
        ...
        try:
            ...
            song_name = self.playList.get(fav_song_index[0])
            result = self.player.remove_songs_from_favourites(song_name)
            if (result.find("deleted")==-1):
                self.playList.delete(fav_song_index[0])
                if fav_song_index[0]==self.sel_song_index_tuple[0]:
                    self.stop_song()
                messagebox.showinfo("Success",result) 
        except (NoSongSelectedError) as ex:
            messagebox.showerror("Error",ex)
    ...
    def load_previous_song(self):
        try:
            if hasattr(self,"sel_song_index_tuple")==False:
                ...
                # print(self.previous_song_index)
                if self.previous_song_index == -1:
                    self.previous_song_index = self.playList.count()-1
                self.playList.select_clear(0,tk.END)
                self.playList.select_set(self.previous_song_index)
                self.play_song()
        except (NoSongSelectedError) as ex:
            messagebox.showerror("Error",ex)
